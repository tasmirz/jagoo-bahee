                    ...
                    {(allResults.comments as Comment[]).slice(currentPage * ITEMS_PER_PAGE, (currentPage + 1) * ITEMS_PER_PAGE).map((comment) => (
                      <div key={comment._id} className="bg-[var(--card)] border border-[var(--border)] rounded-md p-4">
                        ...
                        <div className="flex items-center gap-4 text-xs text-[var(--text-secondary)]">
                          ...
                          <span>•</span>
                          <Link href={`/users/${typeof comment.authorId === 'string' ? comment.authorId : comment.authorId?._id || ''}`} className="hover:underline">
                            u/{typeof comment.authorId === 'string' ? comment.authorId : comment.authorId?.username || comment.authorId?._id}
                          </Link>
                          <span>•</span>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-[var(--text-secondary)] mt-1">
                              {(user.karma ?? user.postKarma ?? 0).toLocaleString()} karma
                            </div>
                          </div>
                          <Link
