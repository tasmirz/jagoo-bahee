    ...
    <View style={styles.page}>
      ...
      <Page colors={colors}>
        ...
        <Row gap={spacing.xs} wrap>
          <Button colors={colors} label="Signal identity" onPress={onIdentity} variant="secondary" system="signal" icon="key-outline" />
          <Button colors={colors} label="Private messages" onPress={onMessages} variant="secondary" system="signal" icon="lock-closed-outline" />
